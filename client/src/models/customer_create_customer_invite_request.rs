...
pub struct CustomerCreateCustomerInviteRequest {
...
impl CustomerCreateCustomerInviteRequest {
    pub fn new(mail_address: String, role: models::DePeriodMittwaldPeriodV1PeriodMembershipPeriodCustomerRoles) -> CustomerCreateCustomerInviteRequest {
