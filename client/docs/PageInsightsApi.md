...
[**v2_pageinsights_get**](PageInsightsApi.md#v2_pageinsights_get) | **GET** /v2/pageinsights | Get detailed performance data for a given domain and path.
[**v2_projects_project_id_pageinsights_get**](PageInsightsApi.md#v2_projects_project_id_pageinsights_get) | **GET** /v2/projects/{projectId}/pageinsights | List websites (specified as domain and path) from a project where performance data is available.
...
> v2_pageinsights_get(domain, path, date)
Get detailed performance data for a given domain and path.
...
## v2_projects_project_id_pageinsights_get

> v2_projects_project_id_pageinsights_get(project_id, domain)
List websites (specified as domain and path) from a project where performance data is available.
