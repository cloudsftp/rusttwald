...
pub struct ProjectCreateProjectInviteRequest {
...
impl ProjectCreateProjectInviteRequest {
    pub fn new(mail_address: String, role: models::DePeriodMittwaldPeriodV1PeriodMembershipPeriodProjectRoles) -> ProjectCreateProjectInviteRequest {
