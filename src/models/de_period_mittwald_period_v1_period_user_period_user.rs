...
pub struct DePeriodMittwaldPeriodV1PeriodUserPeriodUser {
...
impl DePeriodMittwaldPeriodV1PeriodUserPeriodUser {
    pub fn new(person: models::DePeriodMittwaldPeriodV1PeriodCommonsPeriodPerson, user_id: uuid::Uuid) -> DePeriodMittwaldPeriodV1PeriodUserPeriodUser {
        DePeriodMittwaldPeriodV1PeriodUserPeriodUser {
            avatar_ref: None,
            email: None,
