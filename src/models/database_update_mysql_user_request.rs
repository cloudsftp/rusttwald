...
pub struct DatabaseUpdateMysqlUserRequest {
...
impl DatabaseUpdateMysqlUserRequest {
    pub fn new(access_level: AccessLevel, description: String) -> DatabaseUpdateMysqlUserRequest {
        DatabaseUpdateMysqlUserRequest {
            access_ip_mask: None,
            access_level,
            description,
