...
pub struct ContractTerminateContractItemRequest {
...
impl ContractTerminateContractItemRequest {
    pub fn new() -> ContractTerminateContractItemRequest {
        ContractTerminateContractItemRequest {
            reason: None,
